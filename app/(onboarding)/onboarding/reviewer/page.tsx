...
export default async function ReviewerOnboardingPage() {
  ...
  return <AuthShell eyebrow="Account / Workspace · Step 2 of 2" title="Set up your review workspace" description="Your organization and jurisdiction define the review context. Dealership data access is assigned separately."><ReviewerOnboardingForm /></AuthShell>;
}
