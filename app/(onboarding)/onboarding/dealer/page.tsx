...
export default async function DealerOnboardingPage() {
  ...
  return <AuthShell eyebrow="Dealership setup" title="Tell us which dealership you represent" description="This creates the organization boundary used for transaction records, imports, evidence, and team access."><DealerOnboardingForm /></AuthShell>;
}
