...
export default async function DealerLayout({ children }: { children: React.ReactNode }) {
  const actor = await requireProductActor(["DEALER_ADMIN", "DEALER_USER"]); const dealership = actor.dealershipId ? getDealerContext(actor.dealershipId) : null; const data = getDealerProductData(actor); const cookieStore = await cookies();
